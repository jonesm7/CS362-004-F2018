...
int villageEffectCard(int currentPlayer, struct gameState *state, int handPos) {
              //+1 Card
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case remodel:
      return remodelCardEffect(state, currentPlayer, choice1, choice2, handPos);
                
    case smithy:
      return smithyCardEffect(currentPlayer, state, handPos);
      
    case village:
      return villageEffectCard(currentPlayer, state, handPos);
